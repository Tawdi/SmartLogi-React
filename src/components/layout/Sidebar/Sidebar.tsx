...
const Sidebar: React.FC<SidebarProps> = ({ isOpen = true, onClose }) => {
  ...
  // Navigation items based on roles (as per SDMS requirements)
  ...
  // Filter items based on user role (future implementation)
    ...
    <>
      ...
      <aside
        className={cn(
          ...
          'w-64 bg-card border-r border-foreground/10',
