            ...
            <Container>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div className="col-span-1 md:col-span-2">
                            ...
                            <p className="text-foreground/60 mb-4">
                                Système de gestion de livraison intelligent pour optimiser
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li>
                                    <Link to="/tracking" className="text-foreground/60 hover:text-primary transition-colors">
                                        Suivi Colis
                                    </Link>
                                </li>
                                <li>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li>
                                    <Link to="/faq" className="text-foreground/60 hover:text-primary transition-colors">
                                        FAQ
                                    </Link>
                                </li>
                                <li>
                ...
                <div className="border-t border-foreground/10 py-6">
                    <p className="text-center text-foreground/60 text-sm">
                        &copy; {currentYear} SmartLogi SDMS. Tous droits réservés.
                    </p>
                </div>
            </Container>
        </footer>
